                    ...
                    +' <div class="row1" id="bookingSeatTicket">'
                      ...
                      +' <div class="btn-group bootstrap-select mr10">'
                        +' <button title="0"'
                          ...
                          +' <span class="filter-option pull-left">8</span>&nbsp;<span'
                            +' class="caret"></span>'
                        +' </button>'
                        +' <div class="dropdown-menu open"'
                          +' style="overflow: hidden; min-height: 70px; max-height: 607px;">'
                          +' <ul class="dropdown-menu inner selectpicker" role="menu"'
                            +' style="-ms-overflow-y: auto; min-height: 68px; max-height: 605px;">'
                            +' <li rel="0"><a tabindex="0"><span class="text">0</span><i'
                            ...
                            +' <li rel="7"><a tabindex="0"><span class="text">7</span><i'
                                +' class="glyphicon glyphicon-ok icon-ok check-mark"></i></a></li>'
                            +' <li class="selected" rel="8"><a tabindex="0"><span'
                                +' class="text">8</span><i'
                                +' class="glyphicon glyphicon-ok icon-ok check-mark"></i></a></li>'
                          +' </ul>'
                        +' </div>'
                    ...
                    +' <div class="row3">'
                      ...
                      +' <div class="place"'
                        ...
                        +' <div class="seat_wrap">'
                          ...
                          +' <div class="seat_position" id="seatPositionList"'
                            +' style="width: 273px; height: 142px;">'
                            +' <span class="exit left_right"'
                              +' style="left: 277px; top: -18px;"></span><span'
                              +' class="line line_a" style="left: 0px; top: 0px;">A</span>'
                            +' <button title="A1(선택됨)" class="seat_selected"'
                              +' id="seat_A_1_1_0_10"'
                            ...
                            +' <button title="A2(선택됨)" class="seat_selected"'
                              +' id="seat_A_2_1_1_10"'
                            ...
                            +' <button title="A3(선택됨)" class="seat_selected"'
                              +' id="seat_A_3_1_2_10"'
                            ...
                            +' <button title="A4(선택됨)" class="seat_selected"'
                              +' id="seat_A_4_1_3_10"'
                    ...
                    +' <div class="row2">'
                      ...
                      +' <div'
                        ...
                        +' <ul class="info">'
                          ...
                          +' <li id="countSelectedByTicket"><span>일반 4명&nbsp;</span></li>'
                        +' </ul>'
                        +' <ul class="seat" id="selectedSeatNumbers1">'
                          +' <li data-seat-num="A1">A1</li>'
                          +' <li data-seat-num="A2">A2</li>'
                          +' <li data-seat-num="A3">A3</li>'
                          +' <li data-seat-num="A4">A4</li>'
                        +' </ul>'
                      +' </div>'
                      +' <p class="price">'
                        +' <strong id="ticketTotalPrice">36,000</strong> 원'
                      +' </p>'
